...
public final class NTPClient {
    ...
    static class callProcess extends TimerTask {
        String[] args;
        public callProcess(String[] args){
            this.args = args;
        }
    ...
    public static final void main(String[] args) {
        ...
        System.out.print("Digite a frequencia de atualizacao: ");
        int att = scanner.nextInt();

        Timer timer = new Timer();
        timer.schedule(new callProcess(args), 0, att * 1000);
